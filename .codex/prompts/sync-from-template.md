...
3. Merge per the additive semantics: global artifacts refresh from the template; **project-specific artifacts** (`.codex/agents/project/`, `.codex/skills/project/`, and any path the marker declares consumer-owned) MUST NEVER be overwritten.
