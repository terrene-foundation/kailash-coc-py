...
3. Apply per category: SHARED artifacts are replaced whole from the template; **consumer-owned paths** — `.claude/agents/project/`, `.claude/skills/project/`, `.claude/rules/project/`, `.claude/commands/project/`, `.claude/team-memory/**`, and any path the marker declares consumer-owned — MUST NEVER be overwritten.
