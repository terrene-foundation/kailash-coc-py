...
## Red Team Statistics (historical — audit of 2026-03-30)

Provenance for the findings above, recorded as of **2026-03-30**. The roster names are
those of the agents that ran THEN; `deep-analyst` and `coc-expert` no longer exist
(`security-reviewer` and `gold-standards-validator` do). Read this as a dated audit
record, NOT as a current dispatch list — the equivalent round today is
`security-reviewer` + `reviewer` per `rules/agents.md` § Quality Gates.

| Metric          | Value                                                                                 |
| --------------- | ------------------------------------------------------------------------------------- |
| Rounds          | 2                                                                                     |
| Agents deployed | 4 (security-reviewer, deep-analyst†, coc-expert†, gold-standards-validator) — † retired |
| Total findings  | 30+                                                                                   |
